...
SELECT * 
FROM "HEALTHCARE_DATASET"."PUBLIC"."HEALTHCARE_DATASET"
LIMIT 5;
...
FROM
    "HEALTHCARE_DATASET"."PUBLIC"."HEALTHCARE_DATASET";
...
SELECT INSURANCEPROVIDER, ADMISSIONTYPE, TRUNC(AVG(BILLINGAMOUNT)) AS avg_billing
FROM "HEALTHCARE_DATASET"."PUBLIC"."HEALTHCARE_DATASET"
...
SELECT
  ADMISSIONTYPE,
  TRUNC(AVG(BILLINGAMOUNT)) AS average_billing
FROM
  "HEALTHCARE_DATASET"."PUBLIC"."HEALTHCARE_DATASET"
WHERE HOSPITAL = 'Sons and Miller'
